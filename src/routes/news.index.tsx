...
const postsQO = queryOptions({
  queryKey: ["posts", 50],
  queryFn: () => getPosts({ data: { limit: 50 } }),
});
      ...
      <section className="hero-gradient text-white">
        <div className="container-page py-16">
          ...
          <p className="mt-3 max-w-2xl text-white/80">
            বাংলাদেশের EV ইকোসিস্টেম, রিভিউ ও পলিসি আপডেট।
          </p>
        </div>
      </section>
          ...
          {posts.map((p) => (
            ...
            >
              ...
              <div className="flex flex-1 flex-col p-5">
                ...
                <h2 className="mt-2 line-clamp-3 font-display text-lg font-bold leading-snug group-hover:text-primary">
                  {p.title_bn}
                </h2>
