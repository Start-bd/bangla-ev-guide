      ...
      <div className="container-page grid gap-10 py-14 md:grid-cols-4">
        <div>
          ...
          <div className="mt-4 flex gap-3">
            <a
              aria-label="Facebook"
              href="https://www.facebook.com/banglaev"
              target="_blank"
              rel="noopener"
            ...
            <a
              aria-label="YouTube"
              href="https://www.youtube.com/@banglaev"
              target="_blank"
              rel="noopener"
              className="rounded-full bg-white/10 p-2 hover:bg-primary"
            >
            ...
            <a
              ...
              href="https://www.instagram.com/banglaev"
              target="_blank"
              rel="noopener"
              className="rounded-full bg-white/10 p-2 hover:bg-primary"
            >
        ...
        <div>
          ...
          <ul className="space-y-2 text-sm">
            <li>
              <Link to="/byd/$slug" params={{ slug: "seal" }} className="hover:text-primary">
                BYD Seal
              </Link>
            </li>
            <li>
              <Link to="/byd/$slug" params={{ slug: "sealion-6" }} className="hover:text-primary">
                BYD Sealion 6
              </Link>
            </li>
            <li>
              <Link to="/byd/$slug" params={{ slug: "atto-3" }} className="hover:text-primary">
                BYD Atto 3
              </Link>
            </li>
            <li>
              <Link to="/byd/$slug" params={{ slug: "dolphin" }} className="hover:text-primary">
                BYD Dolphin
              </Link>
            </li>
          </ul>
        ...
        <div>
          ...
          <ul className="space-y-2 text-sm">
            ...
            <li>
              <Link to="/charging" className="hover:text-primary">
                চার্জিং গাইড
              </Link>
            </li>
            <li>
              <Link to="/guide/best-electric-bikes-bangladesh" className="hover:text-primary">
                সেরা ইলেকট্রিক বাইক গাইড
              </Link>
            </li>
          </ul>
        </div>
        ...
        <div>
          ...
          <ul className="space-y-2 text-sm">
            ...
            <li>
              <Link to="/about" hash="partnership" className="hover:text-primary">
                বিজ্ঞাপন ও পার্টনারশিপ
              </Link>
            </li>
            <li>
